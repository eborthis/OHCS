...
#Read in table
censusTable <- read.csv("W:/mtic/vic/rpd/Workarea/ArcGIS_Online/OHCS/Data/Tables/StatsCan/CensusProfile_Combined.csv")
...
for (i in censusTableList) 
{
  ...
  filePath <- paste("W:/mtic/vic/rpd/Workarea/ArcGIS_Online/OHCS/Data/Tables/StatsCan/CensusTables/", elementStr,".csv", sep="")
